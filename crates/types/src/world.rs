...
pub struct ContractRegistered {
    ...
    pub constructor_calldata: Vec<starknet::core::types::Felt>,
}
impl cainome::cairo_serde::CairoSerde for ContractRegistered {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        ...
        __size
            ...
            >::cairo_serialized_size(&__rust.constructor_calldata);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        ...
        __out
            .extend(
                Vec::<
                    starknet::core::types::Felt,
                >::cairo_serialize(&__rust.constructor_calldata),
            );
        __out
    }
    fn cairo_deserialize(
        ...
        __offset
            += Vec::<
                starknet::core::types::Felt,
            >::cairo_serialized_size(&constructor_calldata);
...
impl cainome::cairo_serde::CairoSerde for EventEmitted {
    ...
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        ...
        __out
            .extend(
                starknet::core::types::Felt::cairo_serialize(&__rust.event_selector),
            );
        __out
            .extend(
    ...
    fn cairo_deserialize(
        ...
        let mut __offset = __offset;
        let event_selector = starknet::core::types::Felt::cairo_deserialize(
            __felts,
            __offset,
        )?;
        __offset += starknet::core::types::Felt::cairo_serialized_size(&event_selector);
        let system_address = cainome::cairo_serde::ContractAddress::cairo_deserialize(
            __felts,
            __offset,
        )?;
        __offset
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        match __rust {
            ...
            Event::EventRegistered(val) => {
                EventRegistered::cairo_serialized_size(val) + 1
            }
            Event::ContractRegistered(val) => {
                ContractRegistered::cairo_serialized_size(val) + 1
            }
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            4usize => {
                Ok(
                    Event::EventRegistered(
                        EventRegistered::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            5usize => {
            ...
            7usize => {
                Ok(
                    Event::EventUpgraded(
                        EventUpgraded::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            8usize => {
            ...
            9usize => {
                Ok(
                    Event::EventEmitted(
                        EventEmitted::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            10usize => {
...
impl TryFrom<starknet::core::types::EmittedEvent> for Event {
    ...
    fn try_from(
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "WorldSpawned"))
        {
            ...
            return Ok(
                Event::WorldSpawned(WorldSpawned {
                    creator,
                    class_hash,
                }),
            );
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "EventRegistered"))
        {
            ...
            return Ok(
                Event::EventRegistered(EventRegistered {
                    name,
                    namespace,
                    class_hash,
                    address,
        ...
        if selector
            == starknet::core::utils::get_selector_from_name("ContractRegistered")
                .unwrap_or_else(|_| {
                    panic!("Invalid selector for {}", "ContractRegistered")
                })
        {
            let mut key_offset = 0 + 1;
            let mut data_offset = 0;
            ...
            let constructor_calldata = match Vec::<
                starknet::core::types::Felt,
                ...
                Err(e) => {
                    return Err(
                        format!(
                            ...
                            "constructor_calldata", "ContractRegistered", e
                        ),
                    );
                }
            };
            data_offset
                ...
                >::cairo_serialized_size(&constructor_calldata);
            return Ok(
                Event::ContractRegistered(ContractRegistered {
                    selector,
                    address,
                    class_hash,
                    salt,
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "EventUpgraded"))
        {
            ...
            return Ok(
                Event::EventUpgraded(EventUpgraded {
                    selector,
                    class_hash,
                    address,
                    prev_address,
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "EventEmitted"))
        {
            let mut key_offset = 0 + 1;
            let mut data_offset = 0;
            let event_selector = match starknet::core::types::Felt::cairo_deserialize(
                &event.keys,
                key_offset,
            ) {
                Ok(v) => v,
            ...
            key_offset
                += starknet::core::types::Felt::cairo_serialized_size(&event_selector);
            ...
            let historical = match bool::cairo_deserialize(&event.keys, key_offset) {
                ...
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}", "historical",
                            "EventEmitted", e
                        ),
                    );
                }
            ...
            return Ok(
                Event::EventEmitted(EventEmitted {
                    event_selector,
                    system_address,
                    historical,
                    keys,
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            3usize => {
                Ok(
                    Resource::Namespace(
                        cainome::cairo_serde::ByteArray::cairo_deserialize(
                            __felts,
                            __offset + 1,
                        )?,
                    ),
...
impl<A: starknet::accounts::ConnectedAccount + Sync> WorldContract<A> {
    ...
    pub fn register_contract_getcall(
        ...
        __calldata
            .extend(
                Vec::<starknet::core::types::Felt>::cairo_serialize(constructor_calldata),
            );
        starknet::core::types::Call {
            to: self.address,
