...
const SCARB_MANIFEST: &str = "crates/contracts/Scarb.toml";
const WORLD_ARTIFACT: &str = "crates/contracts/target/dev/dojo_world.contract_class.json";
const MODEL_ARTIFACT: &str =
    "crates/contracts/target/dev/dojo_resource_metadata.contract_class.json";
const OUT_DIR: &str = "crates/types/src/";
