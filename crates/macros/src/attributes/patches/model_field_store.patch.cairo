    ...
    fn update_$field_name$(self: S, key: $model_type$KeyType, value: $field_type$) {
        $model_type$Store::update_member(self, key, $field_selector$, value);
    }

    fn update_$field_name$_from_id(self: S, entity_id: felt252, value: $field_type$) {
        $model_type$ModelValueStore::update_member_from_id(self, entity_id, $field_selector$, value);
    }
